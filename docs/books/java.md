...
![《Head First Java》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424103035793.png)
...
![《Java 核心技术卷 1》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424101217849.png)
...
![《Java 编程思想》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424103124893.png)
...
![《Java 8实战》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424103202625.png)
...
![《Java 并发编程之美》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424112413660.png)
...
![《实战 Java 高并发程序设计》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424112554830.png)
...
![《深入浅出 Java 多线程》在线阅读](https://oss.dearloc.com/github/javaguide/books/image-20220424112927759.png)
...
![《Java 并发实现原理：JDK 源码剖析》-豆瓣](https://oss.dearloc.com/github/javaguide/books/0b1b046af81f4c94a03e292e66dd6f7d.png)
...
![《深入理解 Java 虚拟机》-豆瓣](https://oss.dearloc.com/github/javaguide/books/20210710104655705.png)
...
![《实战 Java 虚拟机》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113158144.png)

![《虚拟机设计与实现:以 JVM 为例》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113210153.png)

如果你对实战比较感兴趣，想要自己动手写一个简易的 JVM 的话，可以看看 **[《自己动手写 Java 虚拟机》](https://book.douban.com/subject/26802084/)** 这本书。

![《自己动手写 Java 虚拟机》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113445246.png)
...
![](https://oss.dearloc.com/java-guide-blog/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM0MzM3Mjcy,size_16,color_FFFFFF,t_70.png)
...
![《Spring 实战》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113512453.png)
...
![](https://oss.dearloc.com/github/javaguide/books/20210328171223638.png)
...
![《Spring Boot 编程思想（核心篇）》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113546513.png)
...
![《Spring Boot 实战》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113614768.png)
...
![《Netty 实战》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113715369.png)
...
![《Netty 进阶之路：跟着案例学 Netty》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113747345.png)
...
![](https://oss.dearloc.com/github/javaguide/open-source-project/image-20220503085034268.png)
...
![《Java 性能权威指南》-豆瓣](https://oss.dearloc.com/github/javaguide/books/image-20220424113809644.png)
...
![](https://oss.dearloc.com/github/javaguide/books/20210412224443177.png)

《从零开始学架构》这本书对应的有一个极客时间的专栏—《从零开始学架构》，里面的很多内容都是这个专栏里面的，两者买其一就可以了。我看了很小一部分，内容挺全面的，是一本真正在讲如何做架构的书籍。

![](https://oss.dearloc.com/github/javaguide/books/20210412232441459.png)
...
![](https://oss.dearloc.com/github/javaguide-mianshituji/image-20220830103023493.png)

![](https://oss.dearloc.com/github/javaguide-mianshituji/image-20220830102925775.png)

[JavaGuide](https://dearloc.com/) 的面试版本，涵盖了 Java 后端方面的大部分知识点比如 集合、JVM、多线程还有数据库 MySQL 等内容。

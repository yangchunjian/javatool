...
![浏览器 Trie 树效果展示](https://oss.dearloc.com/github/javaguide/system-design/security/brower-trie.png)
...
![敏感词 Trie 树](https://oss.dearloc.com/github/javaguide/system-design/security/sensitive-word-trie.png)
...
![Apache Commons Collecions 中的 Trie 树实现](https://oss.dearloc.com/github/javaguide/system-design/security/common-collections-trie.png)
...
![Hutool 的 DFA 算法](https://oss.dearloc.com/github/javaguide/system-design/security/hutool-dfa.png)

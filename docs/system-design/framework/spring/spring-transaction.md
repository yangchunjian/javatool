...
![AID->C](https://oss.dearloc.com/github/javaguide/mysql/AID->C.png)
...
我前段时间在我的[知识星球](https://dearloc.com/about-the-author/zhishixingqiu-two-years.html)分享过：**“为什么我们要用接口？”** 。
...
相关阅读：[MySQL 事务隔离级别详解](https://dearloc.com/database/mysql/transaction-isolation-level.html)。

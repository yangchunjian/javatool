...
![Java 异常类层次结构图](https://oss.dearloc.com/github/javaguide/java/basis/types-of-exceptions-in-java.png)
...
![](https://oss.dearloc.com/github/javaguide/java/basis/checked-exception.png)
...
![](https://oss.dearloc.com/github/javaguide/java/basis/unchecked-exception.png)
...
![](https://oss.dearloc.com/github/javaguide/a478c74d-2c48-40ae-9374-87aacf05188c.png)
...
```java
String[] strs = {"JavaGuide", "公众号：JavaGuide", "博客：https://dearloc.com/"};
for (String s : strs) {

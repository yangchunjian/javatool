...
在学习  NIO 之前，需要先了解一下计算机 I/O模型的基础理论知识。还不了解的话，可以参考我写的这篇文章：[Java IO 模型详解](https://dearloc.com/java/io/io-model.html)。
...
下图是 BIO、NIO 和 AIO 处理客户端请求的简单对比图（关于 AIO 的介绍，可以看我写的这篇文章：[Java IO 模型详解](https://dearloc.com/java/io/io-model.html)，不是重点，了解即可）。
...
![Buffer 的子类](https://oss.dearloc.com/github/javaguide/java/nio/buffer-subclasses.png)
...
![position 、limit 和 capacity 之前的关系](https://oss.dearloc.com/github/javaguide/java/nio/JavaNIOBuffer.png)

![position 、limit 和 capacity 之前的关系](https://oss.dearloc.com/github/javaguide/java/nio/NIOBufferClassAttributes.png)
...
![capacity、limit和position每一阶段的变化](https://oss.dearloc.com/github/javaguide/java/nio/NIOBufferClassAttributesDataChanges.png)
...
![Channel 和 Buffer之间的关系](https://oss.dearloc.com/github/javaguide/java/nio/channel-buffer.png)

另外，因为 Channel 是全双工的，所以它可以比流更好地映射底层操作系统的 API。特别是在 UNIX 网络编程模型中，底层操作系统的通道都是全双工的，同时支持读写操作。

`Channel` 的子类如下图所示。

![Channel 的子类](https://oss.dearloc.com/github/javaguide/java/nio/channel-subclasses.png)
...
![Channel继承关系图](https://oss.dearloc.com/github/javaguide/java/nio/channel-inheritance-relationship.png)
...
![Selector 选择器工作示意图](https://oss.dearloc.com/github/javaguide/java/nio/selector-channel-selectionkey.png)

...
![ClassFile 内容分析](https://oss.dearloc.com/java-guide-blog/16d5ec47609818fc.jpeg)

下面这张图是通过 IDEA 插件 `jclasslib` 查看的，你可以更直观看到 Class 文件结构。

![](https://oss.dearloc.com/java-guide-blog/image-20210401170711475.png)
...
![字段的 access_flag 的取值](https://oss.dearloc.com/JVM/image-20201031084342859.png)
...
![方法表的 access_flag 取值](https://oss.dearloc.com/JVM/image-20201031084248965.png)

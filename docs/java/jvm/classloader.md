...
![类加载器层次关系图](https://oss.dearloc.com/github/javaguide/java/jvm/class-loader-parents-delegation-model.png)
...
![Tomcat 的类加载器的层次结构](https://oss.dearloc.com/github/javaguide/java/jvm/tomcat-class-loader-parents-delegation-model.png)

...
![](https://oss.dearloc.com/github/javaguide/java/concurrent/completablefuture-class-diagram.jpg)

`CompletableFuture` 除了提供了更为好用和强大的 `Future` 特性之外，还提供了函数式编程的能力。

![](https://oss.dearloc.com/javaguide/image-20210902092441434.png)
...
![](https://oss.dearloc.com/javaguide/image-20210902093026059.png)

...
![Java 运行时数据区域（JDK1.8 之后）](https://oss.dearloc.com/github/javaguide/java/jvm/java-runtime-data-areas-jdk1.8.png)
...
![Java 线程状态变迁图](https://oss.dearloc.com/github/javaguide/java/concurrent/640.png)

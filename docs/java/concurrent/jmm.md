...
![缓存一致性协议](https://oss.dearloc.com/github/javaguide/java/concurrent/cpu-cache-protocol.png)
...
![](https://oss.dearloc.com/github/javaguide/java/concurrent/image-20220731155332375.png)
...
![happens-before 与 JMM 的关系](https://oss.dearloc.com/github/javaguide/java/concurrent/image-20220731084604667.png)

...
![](https://oss.dearloc.com/github/javaguide/AQS.png)
...
![CLH 队列结构](https://oss.dearloc.com/github/javaguide/java/concurrent/clh-queue-structure.png)
...
![CLH 队列](https://oss.dearloc.com/github/javaguide/java/concurrent/clh-queue-state.png)
...
![AQS 独占模式获取锁](https://oss.dearloc.com/github/javaguide/java/concurrent/aqs-exclusive-mode-acquire-lock.png)

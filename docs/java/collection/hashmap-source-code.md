...
![jdk1.8 之前的内部结构-HashMap](https://oss.dearloc.com/github/javaguide/java/collection/jdk1.7_hashmap.png)
...
![jdk1.8之后的内部结构-HashMap](https://oss.dearloc.com/github/javaguide/java/collection/jdk1.8_hashmap.png)
...
![ ](https://oss.dearloc.com/github/javaguide/database/sql/put.png)

...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220720181630203.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719124403897.png)
...
Redis 中的 List 其实就是链表数据结构的实现。我在 [线性数据结构 :数组、链表、栈、队列](https://dearloc.com/cs-basics/data-structure/linear-data-structure.html) 这篇文章中详细介绍了链表这种数据结构，我这里就不多做介绍了。

许多高级编程语言都内置了链表的实现比如 Java 中的 `LinkedList`，但是 C 语言并没有实现链表，所以 Redis 实现了自己的链表数据结构。Redis 的 List 的实现为一个 **双向链表**，即可以支持反向查找和遍历，更方便操作，不过带来了部分额外的内存开销。

![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719124413287.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/redis-list.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719124421703.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719124430264.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719073733851.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719074543513.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719124437791.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/2021060714195385.png)
...
![](https://oss.dearloc.com/github/javaguide/database/redis/image-20220719071115140.png)

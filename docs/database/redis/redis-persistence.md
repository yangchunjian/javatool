...
![](https://oss.dearloc.com/github/javaguide/database/redis/redis4.0-persitence.png)
...
![AOF 工作基本流程](https://oss.dearloc.com/github/javaguide/database/redis/aof-work-process.png)
...
![AOF 记录日志过程](https://oss.dearloc.com/github/javaguide/database/redis/redis-aof-write-log-disc.png)
...
![AOF 重写](https://oss.dearloc.com/github/javaguide/database/redis/aof-rewrite.png)

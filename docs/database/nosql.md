...
![](https://oss.dearloc.com/github/javaguide/database/mongodb/sql-nosql-tushi.png)
...
![NoSQL 数据模型](https://oss.dearloc.com/github/javaguide/database/mongodb/types-of-nosql-datastores.png)

...
![Github简历](https://oss.dearloc.com/2020-11/image-20201108192205620.png)

通过 <https://www.githubtrends.io/wrapped> 这个网站，你可以生成一份 Github 个人年报，这个年报会列举出你在这一年的项目贡献情况、最常使用的编程语言、详细的贡献信息。

![](https://oss.dearloc.com/github/dootask/image-20211226144607457.png)

## 个性化 Github 首页

Github 目前支持在个人主页自定义展示一些内容。展示效果如下图所示。

![个性化首页展示效果](https://oss.dearloc.com/java-guide-blog/image-20210616221212259.png)

想要做到这样非常简单，你只需要创建一个和你的 Github 账户同名的仓库，然后自定义`README.md`的内容即可。

展示在你主页的自定义内容就是`README.md`的内容（_不会 Markdown 语法的小伙伴自行面壁 5 分钟_）。

![创建一个和你的Github账户同名的仓库](https://oss.dearloc.com/java-guide-blog/image-20201107110309341.png)
...
![通过github-readme-stats动态生成GitHub统计信息 ](https://oss.dearloc.com/java-guide-blog/image-20210616221312426.png)
...
![项目徽章](https://oss.dearloc.com/2020-11/image-20201107143136559.png)

并且，你不光可以生成静态徽章，shield.io 还可以动态读取你项目的状态并生成对应的徽章。

![自定义项目徽章](https://oss.dearloc.com/2020-11/image-20201107143502356.png)

生成的描述项目状态的徽章效果如下图所示。

![描述项目状态的徽章](https://oss.dearloc.com/2020-11/image-20201107143752642.png)

## 自动为项目添加贡献情况图标

通过 repobeats 这个工具可以为 Github 项目添加如下图所示的项目贡献基本情况图表，挺不错的 👍

![](https://oss.dearloc.com/github/dootask/repobeats.png)

地址：<https://repobeats.axiom.co/> 。

## Github 表情

![Github表情](https://oss.dearloc.com/2020-11/image-20201107162254582.png)

如果你想要在 Github 使用表情的话，可以在这里找找：[www.webfx.com/tools/emoji-cheat-sheet/](https://www.webfx.com/tools/emoji-cheat-sheet/)。

![在线Github表情](https://oss.dearloc.com/2020-11/image-20201107162432941.png)
...
![Chrome插件Octotree](https://oss.dearloc.com/2020-11/image-20201107144944798.png)
...
![](https://oss.dearloc.com/2020-11/image-20201107145749659.png)

使用 SourceGraph 阅读代码的就像下面这样，同样是树形结构展示代码，但是我个人感觉没有 Octotree 的手感舒服。不过，SourceGraph 内置了很多插件，而且还支持类之间的跳转！

![](https://oss.dearloc.com/2020-11/image-20201107150307314.png)
...
![](https://oss.dearloc.com/2020-11/image-20201107160817672.png)
...
![](<https://oss.dearloc.com/2020-11/iShot2020-11-07%2016.14.14%20(1).png>)

不过，目前 Github 已经自动为 Markdown 文件生成了目录，只是需要通过点击的方式才能显示出来。

![](https://oss.dearloc.com/github/cosy/image-20211227093215005.png)
...
![](https://oss.dearloc.com/github/javaguide/github-explore.png)
...
![](https://oss.dearloc.com/github/javaguide/image-20211227100147433.png)

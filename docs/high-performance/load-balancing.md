...
![多服务实例-负载均衡](https://oss.dearloc.com/github/javaguide/high-performance/load-balancing/multi-service-load-balancing.drawio.png)
...
关于 Nginx 的常见知识点总结，[《Java 面试指北》](https://dearloc.com/zhuanlan/java-mian-shi-zhi-bei.html) 中「技术面试题篇」中已经有对应的内容了，感兴趣的小伙伴可以去看看。

![](https://oss.dearloc.com/github/javaguide/image-20220328105759300.png)
...
![](https://oss.dearloc.com/github/javaguide/high-performance/load-balancing/spring-cloud-lb-gateway.png)
...
![](https://oss.dearloc.com/github/javaguide/high-performance/load-balancing/6997605302452f07e8b28d257d349bf0.png)

现在的 DNS 解析几乎都支持 IP 地址的权重配置，这样的话，在服务器性能不等的集群中请求分配会更加合理化。像我自己目前正在用的阿里云 DNS 就支持权重配置。

![](https://oss.dearloc.com/github/javaguide/aliyun-dns-weight-setting.png)
...
![](https://oss.dearloc.com/github/javaguide/nginx-load-balance.png)
...
![](https://oss.dearloc.com/github/javaguide/SpringCloudNetflix.png)

...
![TCP发送窗口结构](https://oss.dearloc.com/github/javaguide/cs-basics/network/tcp-send-window.png)
...
![TCP接收窗口结构](https://oss.dearloc.com/github/javaguide/cs-basics/network/tcp-receive-window.png)
...
![TCP的拥塞控制](https://oss.dearloc.com/github/javaguide/cs-basics/network/tcp-congestion-control.png)

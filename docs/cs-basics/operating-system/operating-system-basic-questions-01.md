...
![](https://oss.dearloc.com/2020-8/image-20200807161118901.png)
...
![Kernel_Layout](https://oss.dearloc.com/2020-8/Kernel_Layout.png)
...
![Linux 操作系统](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/linux/linux.png)
...
![用户态和内核态](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/usermode-and-kernelmode.png)
...
![用户态切换到内核态的 3 种方式](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/the-way-switch-between-user-mode-and-kernel-mode.drawio.png)
...
![系统调用](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/system-call.png)
...
![系统调用的过程](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/system-call-procedure.png)
...
![进程状态图转换图](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/state-transition-of-process.png)
...
![常见进程调度算法](https://oss.dearloc.com/github/javaguide/cs-basics/network/scheduling-algorithms-of-process.png)
...
![僵尸进程查看](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/zombie-process-view.jpg)
...
![进程-资源分配图](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/process-resource-allocation-diagram.jpg)

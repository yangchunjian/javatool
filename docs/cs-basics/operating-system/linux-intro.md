...
![Linux 之父](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/linux/linux-father.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/linux/Linux-Logo.png)
...
![ Linux 命令快查](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/linux/linux-command-search.png)

另外，[shell.how](https://www.shell.how/) 这个网站可以用来解释常见命令的意思，对你学习 Linux 基本命令以及其他常用命令（如 Git、NPM）。

![shell.how 使用示例](https://oss.dearloc.com/github/javaguide/cs-basics/operating-system/linux/shell-now.png)

...
![位数组](https://oss.dearloc.com/github/javaguide/cs-basics/algorithms/bloom-filter-bit-table.png)
...
![Bloom Filter 的简单原理示意图](https://oss.dearloc.com/github/javaguide/cs-basics/algorithms/bloom-filter-simple-schematic-diagram.png)
...
```java
String value1 = "https://dearloc.com/";

...
![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/id-after-the-sub-table-not-conflict.png)

### 分布式 ID 需要满足哪些要求?

![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/distributed-id-requirements.png)
...
![数据库主键自增](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/the-primary-key-of-the-database-increases-automatically.png)
...
![数据库号段模式](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/database-number-segment-mode.png)
...
![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/nosql-distributed-id.png)
...
![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/mongodb9-objectId-distributed-id.png)
...
![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/rfc-4122-uuid.png)
...
![Version 1 版本下生成的 UUID 的示例](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/version1-uuid.png)
...
![Snowflake 示意图](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/snowflake-distributed-id-schematic-diagram.png)
...
![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/uidgenerator-distributed-id-schematic-diagram.png)

可以看出，和原始 Snowflake(雪花算法)生成的唯一 ID 的组成不太一样。并且，上面这些参数我们都可以自定义。

UidGenerator 官方文档中的介绍如下：

![](https://oss.dearloc.com/github/javaguide/system-design/distributed-system/uidgenerator-introduction-official-documents.png)
...
![](https://oss.dearloc.com/github/javaguide/distributed-system/distributed-id/leaf-principle.png)
...
![](https://oss.dearloc.com/github/javaguide/distributed-system/distributed-id/tinyid-principle.png)
...
![](https://oss.dearloc.com/github/javaguide/distributed-system/distributed-id/tinyid-architecture-design.png)

...
![rsm-architecture.png](https://oss.dearloc.com/github/javaguide/paxos-rsm-architecture.png)
...
![](https://oss.dearloc.com/github/javaguide/paxos-server-state.png)

`图-2：服务器的状态`

### 2.2 任期

![](https://oss.dearloc.com/github/javaguide/paxos-term.png)

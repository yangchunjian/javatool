...
3. **分布式锁**：通过创建唯一节点获得分布式锁，当获得锁的一方执行完相关代码或者是挂掉之后就释放锁。分布式锁的实现也需要用到 **Watcher 机制** ，我在 [分布式锁详解](https://dearloc.com/distributed-system/distributed-lock.html) 这篇文章中有详细介绍到如何基于 ZooKeeper 实现分布式锁。
...
![ZooKeeper 数据模型](https://oss.dearloc.com/github/javaguide/distributed-system/zookeeper/znode-structure.png)
...
![ZooKeeper Watcher 机制](https://oss.dearloc.com/github/javaguide/distributed-system/zookeeper/zookeeper-watcher.png)
...
![ZooKeeper 集群架构](https://oss.dearloc.com/github/javaguide/distributed-system/zookeeper/zookeeper-cluster.png)
...
![ZooKeeper 集群中角色](https://oss.dearloc.com/github/javaguide/distributed-system/zookeeper/zookeeper-cluser-roles.png)
...
- [Paxos 算法详解](https://dearloc.com/distributed-system/protocol/paxos-algorithm.html)
- [Zookeeper ZAB 协议分析](https://dbaplus.cn/news-141-1875-1.html)
- [Raft 算法详解](https://dearloc.com/distributed-system/protocol/raft-algorithm.html)
